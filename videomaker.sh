...
mkdir blurVideo2
#download the videos
youtube-dl $(curl -H "user-agent: 'your bot 0.1'" https://www.reddit.com/r/HotTiktoks/top.json?limit=12 | jq '.' | grep url_overridden_by_dest | grep -Eoh "https:\/\/v\.redd\.it\/\w{13}")
